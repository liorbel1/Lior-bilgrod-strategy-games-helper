...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" Runat="Server">
   <div class="home-content" dir="ltr">
    <h1>welcome to the strategy world</h1>
    
    <p>The world of strategy games is where thinking, tactical planning, and foresight beat speed. There is no feeling more satisfying than seeing a complex plan come to life, outsmarting your opponent, managing resources wisely, and winning through intellect rather than just quick reflexes.</p>
    ...
    <img src="images/thinker.jpg" alt="Choosing a strategy game" class="page-image" />
</div>
</asp:Content>
