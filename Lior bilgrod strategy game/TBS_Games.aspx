<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TBS_Games.aspx.cs" Inherits="TBS_Games" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" Runat="Server">
    <div class="content-page" dir="ltr">
    <h1>Turn-Based Strategy (TBS): Take Your Time, Plan Your Victory</h1>
    ...
    <h4>1. Sid Meier's Civilization VI</h4>
    <p>The ultimate "just one more turn" experience. In <em>Civilization VI</em>, you take a historical society from the Stone Age all the way to the Information Age. You will build sprawling cities, research new technologies, and compete against other famous leaders to achieve a scientific, cultural, or military victory.</p>
    
    <img src="images/c6.jpg" alt="Civilization VI sprawling empire map" class="page-image" />
